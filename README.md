...
# Bem vindo a Valorant Info
Criei um painel que busca as informações dos Agentes(Informaçoes das habilidades e também um vídeo mostrando como e usada)  
Também as informações das armas e Skins, Level e Chromas de cada uma.

[VALORANT API](https://valorant-api.com/)

# Exemplo de uso

![enter image description here](https://github.com/ProHatp/valorant-infos/blob/main/demo.gif)
